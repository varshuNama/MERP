...
public class TimeSheetReport extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		prefs = AppPreferences.getInstance(TimeSheetReport.this);
		connectionDetector = new ConnectionDetector(TimeSheetReport.this);

		init(TimeSheetReport.this);
		new AsyncTaskViewDetailTimeSheet(TimeSheetReport.this,
				spinyear.getSelectedItem() + "", "S", "1").execute("");

	}

	private void init(TimeSheetReport v) {
	...
	public void ViewTimeSheetSearch(String responsegetdata) {
		if (arraylist.size() != 0 && arraylist != null) {
			...
			adapter = new ViewTimeSheetAdapter(TimeSheetReport.this, arraylist,
					checkFlag);
	...
	void ViewTimeSheetData(String responsegetdata) {
		if (arraylist.size() != 0 && arraylist != null) {
			...
			adapter = new ViewTimeSheetAdapter(TimeSheetReport.this, arraylist,checkFlag);
			listview.setAdapter(adapter);
		} else {
			norecord.setVisibility(View.VISIBLE);
			norecord.setText(responsegetdata);
	...
	public void onClick(View v) {
		...
		case R.id.viewback:
			if (checkFlag == "2") {
				Intent intent = new Intent(TimeSheetReport.this,
		...
		case R.id.viewBtn:
			if (connectionDetector.isConnectingToInternet())
				...
				new SweetAlertDialog(TimeSheetReport.this,
	...
	public void onBackPressed() {
		...
		super.onBackPressed();
		if (checkFlag == "2") {
			Intent intent = new Intent(TimeSheetReport.this, TimeSheetReport.class);
			startActivity(intent);
			finish();
